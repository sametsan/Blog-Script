...
tema_tablo_ac("$kayit->baslik");

$resim=kayit_resim_url($kayit->no);

if(file_exists($resim))echo "<img title='Resim Yok' src='$resim' align=left width=250 >";
echo "<span>".nl2br($kayit->aciklama)."</span><br><br><br>";
echo "<span> <b>Kaynak : </b><a target='_blank' href=$kayit->kaynak>$kayit->kaynak</a></span><br><br>";
...
<a target=_blank href=rss.php?no=$kayit->no><img border=0 src=$tema/resim/rss.png></a>
...
print "<input  type=button value=Gönder onclick='yorum_yap()'>";
